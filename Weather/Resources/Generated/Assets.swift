...
internal enum WeatherAsset {
  internal enum Color {
    internal static let black = ColorAsset(name: "Black")
    internal static let blue = ColorAsset(name: "Blue")
    internal static let cloudy = ColorAsset(name: "Cloudy")
    internal static let lightGrey = ColorAsset(name: "LightGrey")
  ...
  internal enum Image {
    ...
    internal static let partlysunny = ImageAsset(name: "partlysunny")
    internal static let rain = ImageAsset(name: "rain")
    internal static let forestCloudy = ImageAsset(name: "forest_cloudy")
    internal static let forestRainy = ImageAsset(name: "forest_rainy")
    internal static let forestSunny = ImageAsset(name: "forest_sunny")
